...
1. `docker-compose up -d` to spin up dev container and database (ensure port `23306` is free)
...
- Ensure you don't have a database running locally and listening on port `23306` this will cause the database container to fail starting up.
